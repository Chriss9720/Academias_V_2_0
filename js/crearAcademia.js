$(document).ready(() => {
    ...
    const cargar = () => {
        ...
        let pagina = buscarCookie("paginaDocenteAddAcademia");
        pagina = maximo > pagina ? pagina : 0;
        document.cookie = `paginaDocenteAddAcademia=${pagina};max-age=${60 * 10};`;
...
const paginaRapida = (pagina) => {
    document.cookie = `paginaDocenteAddAcademia=${pagina - 1};max-age=${60 * 10};`;
    location.reload();
}